...
import com.ztstech.vgmate.weigets.LoadFooter;

import java.util.ArrayList;
import java.util.List;

public class MyXRecycler extends RecyclerView {
    ...
    private int mLoadingMoreProgressStyle = ProgressStyle.BallScaleRipple;
    ...
    public MyXRecycler(Context context) {
        this(context, null);
    }

    public MyXRecycler(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyXRecycler(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        LoadFooter footView = new LoadFooter(getContext());
        footView.setProgressStyle(mLoadingMoreProgressStyle);
//        View footView = LayoutInflater.from(MyApplication.getContext()).inflate(R.layout.pull_to_refresh_foot_view,null);
        //footView.setProgressStyle(mLoadingMoreProgressStyle);
        mFootView = footView;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener.State.EXPANDED) {
                    if (!isLoadingData && mRefreshHeader.getState() != ArrowRefreshHeader.STATE_REFRESHING ) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    MyXRecycler.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    MyXRecycler.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public boolean isHeader(int position) {
            return position == 0 && position < mHeaderViews.size() + 1;
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_REFRESH_HEADER) {
                ...
                mHeader = getHeaderViewByType(viewType);
    ...
    public void onScrolled(int dx, int dy) {
        ...
        if (mMoveCallback != null) {
            if (mCurrentHeight > mHeaderHeight) {
                mMoveCallback.onMove(mHeaderHeight, mHeaderHeight);
            }else {
                mMoveCallback.onMove(mHeaderHeight, mCurrentHeight);
            }
        }
    }
...
//    }
    ...
    public interface MoveCallback {
         ...
         * @param currentScrollY 当前滚动的距离
         */
        void onMove(int headerHeight, int currentScrollY);
    }
}