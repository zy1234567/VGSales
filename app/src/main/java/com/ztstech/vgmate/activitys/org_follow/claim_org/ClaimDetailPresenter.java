...
public class ClaimDetailPresenter extends PresenterImpl<ClaimOrgDetailContact.View> implements ClaimOrgDetailContact.Presenter{
    ...
    @Override
    public void approveOrg(String rbiid, String calid,String identtype,String status,String type,String yesorno) {
        ...
        }.run(new ApproveClaimOrg(rbiid,status,calid,identtype,type,yesorno).run());
    }
}
