...
public class InformationRecyclerAdapter extends SimpleRecyclerAdapter<InformationModel> {

    @Override
    public SimpleViewHolder<InformationModel> onCreateViewHolder(ViewGroup parent, int viewType) {
